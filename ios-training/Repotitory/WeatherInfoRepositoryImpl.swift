//
//  WeatherInfoRepositoryImpl.swift
//  ios-training
//
...
struct WeatherInfoRepositoryImpl: WeatherInfoRepository {
    // MARK: Errors
...
private extension WeatherInfoRepositoryImpl {
    ...
    func decodeResponse(_ jsonString: String) throws -> APIResponse {
        ...
        return try Self.decoder.decode(APIResponse.self, from: data)
    }
}
